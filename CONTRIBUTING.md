...
- Please **do not** use the issue tracker for personal support requests (use our discord or
...
> 3. Further steps, etc.
>
> `<url>` - a link to the test case / image / gif of problem
>
...
implementing features, refactoring code, adding a new dependency),
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/Taha321/accessible_controller_firmware.git
   ```
...
5. **IMPORTANT** Test your changes in both the host environment **and** on-board environment to ensure code is production ready
...
**IMPORTANT**: Please review [build instructions](README.md#build-instructions) if you are having difficulty building and/or uploading code to teensy board.
